...
def contact():
    mess._show(title='Contact us', message="Please contact us on: 'xxxxxxxx@gmail.com'")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title="some files are missing", message="please turn to youtube")
        window.destroy()
...
def change_pass():
    ...
    old.place(x=180, y=45)
    lbl5 = tk.Label(master, text="Enter new Password", bg="white", font=("time", 12, "bold"))
    lbl5.place(x=10, y=45)
    global new
    new = tk.Entry(master, width=25, fg="Black", relief="solid", font=("times", 12, "bold"), show="*")
    new.place(x=180, y=45)
    lbl6 = tk.Label(master, text="Confirm New Password", bg="White", font=("times", 12, "bold"))
    lbl6.place(x=180, y=80)
    global nnew
    nnew = tk.Entry(master, width=25, fg="Black", relief="solid", font=("times", 12, "bold"), show="*")
    nnew.place(x=10, y=120)
    master.mainloop();
...
def clear():
    txt.delete(0, "end")
    res = "1)Take Image >> 2) Save Profile"
...
def TakeImage():
    ...
    assure_path_exists("StudentsDetails/")
...
def TrainImage():
    check_haarcascadefile()
    assure_path_exists("TrainingImageLabel/")
    recognizer = cv2.face_LBPHFaceRecognizer.creat()
    ...
    try:
        ...
        mess._show(title="No Registration", message="Please Register someone first")
        return
    recognizer.save("TrainingImageLabel\Trainner.yml")
    res = "Profile saves Successfully"
    message1.config(text=res)
    message.configure(text="Total Registration till now :" + str(ID[0]))
...
def getImageAndLabels(path):
    ...
    for imagePath in imagePaths:
        ...
        ID = int(os.path.spilt(imagePath)[-1].split(".")[1])
...
takeImg = tk.Button(frame2, text="Take Images", command=TakeImage, fg="white", bg="blue", width=34, height=1,
