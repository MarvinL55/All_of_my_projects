...
class Button():
    def __init__(self, x, y, width, height, buttonText='Button', onclickFunction=None, onePress=False):
        ...
        self.buttonReact = pygame.Rect(self.x, self.y, self.width, self.height)
    ...
    def process(self):
        ...
        if self.buttonReact.collidepoint(mousePos):
        ...
        self.buttonSurface.blit(self.buttonSurf, [
            self.buttonReact.width / 2 - self.buttonSurf.get_rect().width / 2,
            self.buttonReact.height / 2 - self.buttonSurf.get_rect().height / 2
        ])
        screen.blit(self.buttonSurface, self.buttonReact)
...
buttons = [
    ...
    ['Brush Larger', lambda: changebrushSize(['grater'])],
